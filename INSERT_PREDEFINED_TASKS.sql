...
-- IMPORTANTE: Primero verificamos qué casas existen en la BD
-- SELECT DISTINCT house FROM profiles;
-- Usaremos "YNTIBA 2" en lugar de "HYNTIBA2 APTO 406"

-- PASO 1: Insertar tareas de Limpieza Regular para YNTIBA 2
