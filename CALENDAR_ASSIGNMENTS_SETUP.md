# 🗓️ Configurar Asignaciones de Calendario

Para que Chava vea las tareas que Sandra le asigna en el calendario, necesitas configurar la tabla `calendar_assignments` en Supabase.
...
3. **Click:** ▶ **Run**
4. **Deberías ver:** `Tabla calendar_assignments configurada | 0`
5. **Recarga Dashboard:** Ctrl+Shift+F5

## 🧪 Prueba:

1. **Sandra** asigna una tarea a **Chava** en el calendario
2. **Chava** abre el Dashboard
3. **¿Chava ve la tarea asignada?**
   - ✅ **SÍ** → ¡Funciona!
