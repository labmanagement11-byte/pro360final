...
const Inventory: React.FC<InventoryProps> = ({ user, inventory: externalInventory, setInventory: setExternalInventory }) => {
  const airbnbExample: InventoryItem[] = [
    // Cocina
    { name: 'Cucharas', room: 'Cocina', quantity: 12 },
    { name: 'Tenedores', room: 'Cocina', quantity: 12 },
    { name: 'Cuchillos', room: 'Cocina', quantity: 12 },
    { name: 'Platos llanos', room: 'Cocina', quantity: 12 },
    { name: 'Platos hondos', room: 'Cocina', quantity: 12 },
    { name: 'Platos de postre', room: 'Cocina', quantity: 8 },
    { name: 'Vasos', room: 'Cocina', quantity: 12 },
    { name: 'Copas de vino', room: 'Cocina', quantity: 8 },
    { name: 'Copas de agua', room: 'Cocina', quantity: 8 },
    { name: 'Tazas', room: 'Cocina', quantity: 8 },
    { name: 'Sartenes', room: 'Cocina', quantity: 3 },
    { name: 'Ollas', room: 'Cocina', quantity: 4 },
    ...
    { name: 'Cuchillos grandes', room: 'Cocina', quantity: 3 },
    ...
    // Baños
    { name: 'Toallas de baño', room: 'Baños', quantity: 10 },
    { name: 'Toallas de mano', room: 'Baños', quantity: 4 },
    { name: 'Tapetes de baño', room: 'Baños', quantity: 3 },
    { name: 'Cestos de basura', room: 'Baños', quantity: 3 },
    ...
    // Terraza
    { name: 'Sillas', room: 'Terraza', quantity: 6 },
    { name: 'Mesa', room: 'Terraza', quantity: 1 },
    { name: 'Cojines', room: 'Terraza', quantity: 6 },
    { name: 'Cestos de basura', room: 'Terraza', quantity: 1 },
    // Piscina
    { name: 'Toallas de piscina', room: 'Piscina', quantity: 6 },
    { name: 'Flotadores', room: 'Piscina', quantity: 2 },
    { name: 'Sillas de piscina', room: 'Piscina', quantity: 4 },
    // BBQ
    { name: 'Parrilla', room: 'BBQ', quantity: 1 },
    { name: 'Cenicero', room: 'BBQ', quantity: 1 },
    { name: 'Utensilios BBQ', room: 'BBQ', quantity: 4 },
    // Lavandería
    ...
    // Limpieza
    { name: 'Escoba', room: 'Pasillo', quantity: 2 },
    { name: 'Trapeador', room: 'Pasillo', quantity: 2 },
    ...
    { name: 'Linterna', room: 'Pasillo', quantity: 2 },
