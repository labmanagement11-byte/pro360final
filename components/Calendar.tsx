...
const Calendar = ({ users, user, selectedHouse }: CalendarProps) => {
  ...
  const addEvent = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Refresco inmediato + realtime (casas con espacios rompían el filtro eq)
    await fetchEvents(house);
  };
    ...
    <div className="calendar-list">
      ...
      <div className="calendar-events">
        ...
        {showChecklistModal && selectedAssignmentId && (
          <div className="calendar-modal-overlay" style={{position:'fixed',top:0,left:0,width:'100vw',height:'100vh',background:'rgba(0,0,0,0.4)',zIndex:10000,display:'flex',alignItems:'center',justifyContent:'center'}}>
